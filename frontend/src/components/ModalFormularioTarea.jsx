                            ...
                            <div className="sm:flex sm:items-start">
                                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                                    ...
                                    <form onSubmit={handleSubmit}>
                                        <div className='my-5'>
                                            <label className='font-bold'>Nombre Tarea</label>
                                            <input
                                        ...
                                        <div className='my-5'>
                                            <label className='font-bold'>Descripción Tarea</label>
                                            <textarea
                                                placeholder='Ingresa nombre de la tarea'
                                                className="border-2 w-full placeholderbg-gray-600 p-2 mt-2"
                                                value={descripcion}
                                        ...
                                        <div className='my-5'>
                                            <label className='font-bold'>Fecha Entrega</label>
                                            <input
                                                type='date'                                                
                                                className="border-2 w-full placeholderbg-gray-600 p-2 mt-2"
                                                value={fechaEntrega}
                                        ...
                                        <div className='my-5'>
                                            <label className='font-bold'>Prioridad Tarea</label>
                                            <select
                                                className="border-2 w-full placeholderbg-gray-600 p-2 mt-2"
                                                value={prioridad}
